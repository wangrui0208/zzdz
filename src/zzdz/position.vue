<template>
  <div class='position'>
    <!--百度地图容器-->
    <div class='map' id='dituContent' :style="{height:Height+'px'}"></div>
    <tabBar></tabBar>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    createMap() {
      ...
      const ctrl_nav = new BMap.NavigationControl({ anchor: BMAP_ANCHOR_TOP_LEFT, type: BMAP_NAVIGATION_CONTROL_LARGE });
